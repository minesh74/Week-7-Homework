...
public class Person {
   /* Write a class with the name Person. The class needs three fields (instance variables) with the names
    ...
    Write the following methods(instancemethods):
...
*Method named getAge without any parameters, it needs to return the value of the age field.
    ...
    the parameteris less than 0 or greater than 100, it needs to set the age field value to 0.
...
firstName.isEmpty() returnstrue if the String is empty orin other words, when the String does not
